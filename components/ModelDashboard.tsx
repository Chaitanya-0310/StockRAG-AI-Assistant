                ...
                {symbols.map(symbol => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {/* Models List */}
                            {isTrained && status.models.length > 0 ? (
                                        ...
                                        >
                                            ...
                                            <div className="grid grid-cols-3 gap-3 text-sm">
                                                <div>
                                                    ...
                                                    <p className="text-white font-medium">{model.metrics.rmse.toFixed(2)}</p>
                                                </div>
                                                <div>
                                                    <p className="text-slate-500 text-xs">MAE</p>
                                                    <p className="text-white font-medium">{model.metrics.mae.toFixed(2)}</p>
                                                </div>
                                                <div>
                                                    <p className="text-slate-500 text-xs">Samples</p>
                                                    <p className="text-white font-medium">{model.training_samples}</p>
                                                </div>
                                            </div>
